...
pub struct EDLogStatisticsFleetcarrier {
    ...
    fleetcarrier_tradeprofit_total: u64,
    #[serde(rename = "FLEETCARRIER_TRADESPEND_TOTAL")]
    fleetcarrier_tradespend_total: u64,
    #[serde(rename = "FLEETCARRIER_STOLENPROFIT_TOTAL")]
    fleetcarrier_stolenprofit_total: u64,
    #[serde(rename = "FLEETCARRIER_STOLENSPEND_TOTAL")]
    fleetcarrier_stolenspend_total: u64,
...
pub struct EDLogStatistics {
    ...
    bank_ccount: EDLogStatisticsBankAccount,
    combat: EDLogStatisticsCombat,
    crime: EDLogStatisticsCrime,
    smuggling: EDLogStatisticsSmuggling,
    trading: EDLogStatisticsTrading,
    mining: EDLogStatisticsMining,
    exploration: EDLogStatisticsExploration,
    passengers: EDLogStatisticsPassengers,
    #[serde(rename = "Search_And_Rescue")]
    search_and_rescue: EDLogStatisticSearchAndRescue,
    #[serde(rename = "TG_ENCOUNTERS")]
    tg_encounters: Option<EDLogStatisticsTgEncounters>,
    crafting: EDLogStatisticsCrafting,
    crew: EDLogStatisticsCrew,
    multicrew: EDLogStatisticsMulticrew,
    #[serde(rename = "Material_Trader_Stats")]
    material_trader_stats: EDLogStatisticsMaterialTraderStats,
    #[serde(rename = "FLEETCARRIER")]
    fleetcarrier: Option<EDLogStatisticsFleetcarrier>,
    exobiology: Option<EDLogStatisticsExobiology>,
}
